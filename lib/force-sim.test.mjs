...
import { relax, settled, SPRING_DEFAULT, HOME_DEFAULT } from "./force-sim.mjs";
...
test("SPRING_DEFAULT and HOME_DEFAULT are exported and match the documented values", () => {
  assert.equal(SPRING_DEFAULT, 0.06);
  assert.equal(HOME_DEFAULT, 0.1);
});
