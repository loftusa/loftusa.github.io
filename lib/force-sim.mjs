...
// 0.06 -> 0.05 on 2026-07-26: the 55-seat graph pushed spring*lambda_max + home to 1.971,
// exhausting build_previews.mjs's stability margin (divergence at 2.0). 0.05 restores ~1.66.
export const SPRING_DEFAULT = 0.05;
export const HOME_DEFAULT = 0.1;

export function relax(nodes, links, { iterations = 1, spring = SPRING_DEFAULT, home = HOME_DEFAULT } = {}) {
