...
assert sum(b["open"] for b in bins) == 175 and sum(b["both"] for b in bins) == 73

# ---- all 248 connected pairs (open + both), the dot population ----
pairs = []
...
assert sum(1 for a, b in open_pairs if a in no_papers or b in no_papers) == 29
